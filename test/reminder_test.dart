...
void main() {
  ...
  group('Reminder.nextOccurrence', () {
    test('tek seferlik: ileri tarih aynen döner, geçmiş null', () {
      expect(
        make(dateTime: DateTime(2026, 9, 5, 16, 0)).nextOccurrence(now),
        DateTime(2026, 9, 5, 16, 0),
      );
      expect(
        make(dateTime: DateTime(2026, 9, 5, 9, 0)).nextOccurrence(now),
        isNull,
      );
    });
    ...
    test('her gün: saat geçtiyse yarına kayar', () {
      ...
      final later = make(
        dateTime: DateTime(2026, 9, 1, 21, 0),
        repeat: RepeatRule.daily,
      );
    ...
    test('hafta içi: cumartesiden pazartesiye atlar', () {
      final r = make(
        dateTime: DateTime(2026, 9, 1, 8, 30),
    ...
    test('her hafta: aynı gün ve saat, bir sonraki hafta', () {
      final r = make(
        dateTime: DateTime(2026, 9, 5, 12, 0),
    ...
    test('sıradaki iki çalma: tekrarlıda ardışık, tek seferlikte tek', () {
      ...
      expect(daily.nextOccurrences(now, 2), [
